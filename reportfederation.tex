...
% who needs to take the action, UKRI, DSIT, AHRC
% community convenes iteslf, but funding is required from UKR
% level of agency, how much the community can sort out itself if they just had the funding
% what is the UKRI role - policy decision
% how to ensure funds is equitable
% policy, 
% UKRI-invest in infrastructure 
% recommendation for UKRI, and for community
% organise 
% high level policy at UKRI, but leave the decision making to community
% research versus infrastructure
% let the communities decide how they will 
% communication - if people are not using the systems, then they don't shout.
% UKRI- organising from above, and action from below. Ukri-funds, organise, and 
% Community selforganise
% External: from the side.
% COsting: give an idea - resources and requirements for each recommendation
% Thehy are producing guidance and a portfolio of things they could invest in the future for infrastructure. Timeline is linked to priority, and we need some number to invest.
% L
